...
PATHFINDER = YAML.load_file("#{Rails.root.to_s}/config/variables/pathfinder.yml") rescue nil unless defined? PATHFINDER
MAPDATA = YAML.load_file("#{Rails.root.to_s}/config/variables/mapdata.yml") rescue nil unless defined? MAPDATA
