...
function update_placeholder(event, ui) {
  if (
    ui.placeholder.parent().attr("id") == "utility-equipment-sortable" ||
    ui.placeholder.parent().attr("id") == "main-equipment-sortable"
  ) {
...
function after_change_simple() {
  $("#main-equipment-sortable, #utility-equipment-sortable")
    .children(".col-md-4")
    .each(function() {
      $(this)
...
function after_change() {
  ...
  $("#utility-equipment-sortable")
    .children(".col-md-12")
    .each(function() {
      utility_ids.push($(this).data("id"));
    });
  $("#main-equipment-sortable")
    .children(".col-md-12")
    .each(function() {
  ...
  $.post(
    "equipment/update",
    { ids: { main: main_ids, utility: utility_ids } },
    function(data) {
