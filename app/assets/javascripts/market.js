$(document).on("turbolinks:load", function() {
  ...
  $(".station-card").on("click", ".market-buy-btn", function(e) {
    ...
    $.post("/market/buy", { id: id, amount: amount }, function(data) {
      ...
      if (data.new_amount && data.new_amount != 0) {
        $(".station-card")
          .find(`[data-target='#` + button.closest(".modal").attr("id") + `']`)
          .parent()
          .parent()
          .children()
          .first()
          .text(data.new_amount + "×");
      } else {
        $(".station-card")
          .find(`[data-target='#` + button.closest(".modal").attr("id") + `']`)
          .parent()
  ...
  $(".station-card").on("click", ".max-buy-btn", function(e) {
    ...
    $(this)
      .closest(".modal")
      .find(".color-highgreen")
      .text(amount * price + " Cr");
    $(this)
      .closest(".modal")
      .find("input")
      .val(amount);
  ...
  $(".station-card").on("click", ".market-appraise-btn", function(e) {
    ...
    $("#market-sell")
      .find(".max-btn")
      .data("loader", $(this).data("loader"));
    $("#market-sell")
      .find(".max-btn")
      .data("type", $(this).data("type"));
    $("#market-sell")
      .find(".market-sell-btn")
      .data("loader", $(this).data("loader"));
    $("#market-sell")
      .find(".market-sell-btn")
      .data("type", $(this).data("type"));
    ...
    $.post(
      "market/appraisal",
      { loader: loader, type: type, quantity: 1 },
      function(data) {
  ...
  $(".station-card").on("click", "#market-sell .max-btn", function(e) {
    ...
    $.post(
      "market/appraisal",
      { loader: loader, type: type, quantity: $(this).data("amount") },
      function(data) {
        $("#selling-price").text(data.price + " Cr");
      }
    );
  ...
  $(".station-card").on("change", "#market-sell .custom-quantity", function(e) {
    ...
    $.post(
      "market/appraisal",
      { loader: loader, type: type, quantity: amount },
      function(data) {
        $("#selling-price").text(data.price + " Cr");
      }
    );
  ...
  $(".station-card").on("click", "#market-sell .market-sell-btn", function(e) {
    ...
    $.post(
      "market/sell",
      { loader: loader, type: type, quantity: amount, price: price },
      function(data) {
        button.html(html);
        button.closest(".modal").modal("hide");
        button = $("#app-container").find(
          '.market-appraise-btn[data-loader="' + loader + '"]'
        );
  ...
  $(".station-card").on("click", ".market-buyorder-btn", function() {
    ...
    var name = $(this)
      .closest(".modal")
      .find(".market-buyorder-loader")
      .val();
    var amount = $(this)
      .closest(".modal")
      .find(".market-buyorder-amount")
      .val();
    var price = $(this)
      .closest(".modal")
      .find(".market-buyorder-price")
      .val();
