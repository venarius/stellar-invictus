...
function app_player_ship() {
  ...
  var app = new PIXI.Application(270, 87, {
    antialias: true,
    autoResize: true
  });
  $(".player-space-ship")
  ...
  var bg = PIXI.Texture.from(
    "https://s3-eu-west-1.amazonaws.com/static.stellar-invictus.com/assets/animations/bg_space_seamless.png"
  );
  ...
  if ($(".enemy-space-ship").data("asteroid-image")) {
    var mining_laser = PIXI.Sprite.from(
      "https://s3-eu-west-1.amazonaws.com/static.stellar-invictus.com/assets/animations/mining/mining-laser-ship.png"
    );
  ...
  for (var i = 0; i < 6; i++) {
    frames.push(
      PIXI.Texture.from(
        "https://s3-eu-west-1.amazonaws.com/static.stellar-invictus.com/assets/animations/explosion/explosion-" +
          i +
          ".png"
      )
    );
  ...
  createStars(
    "https://s3-eu-west-1.amazonaws.com/static.stellar-invictus.com/assets/animations/star-big.png",
    star_min_scale,
    star_max_scale,
    star_min_speed / 4,
    star_max_speed / 4,
...
function enemy_player_ship() {
  ...
  var app = new PIXI.Application(269, 87, {
    antialias: true,
    autoResize: true
  });
  $(".enemy-space-ship")
  ...
  if ($(".enemy-space-ship").data("asteroid-image")) {
    ...
    var asteroid = PIXI.Sprite.from(
      $(".enemy-space-ship").data("asteroid-image")
    );
