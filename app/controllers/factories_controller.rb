class FactoriesController < ApplicationController
  ...
  def craft
    if params[:loader] and params[:type] and current_user.location.industrial_station?
      ...
      if ressources and current_user.blueprints.where(loader: params[:loader]).present?
        ...
        ressources.each do |key, value|
          ...
          render json: {'error_message': I18n.t('errors.not_required_material')}, status: 400 and return if !items.present? || items.count < value.round
        end
